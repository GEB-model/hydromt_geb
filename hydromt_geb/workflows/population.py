...
def generate_locations(
    ...
    for row in range(0, population.shape[0]):
        for col in range(0, population.shape[1]):
            ...
            while cell_population > 0:
                household_size = min(mean_household_size, cell_population)  # cap household size to current population left in cell
    ...
    return household_locations[:total_household_count], household_sizes[:total_household_count]